...
const CategoryCard = ({ image, title, path, className }: CategoryCardProps) => {
  return (
    //Variant 1
    <Link
      to={path}
      className={clsx(
        'group relative min-h-[380px] cursor-pointer overflow-hidden rounded-md shadow-xl transition-all duration-300 hover:shadow-2xl',
        className,
      )}
    >
      <img
